...
s1(Q,Max):-
		...
		remove([32,64,_,_],Result3,Result4),
		remove([2,4,_,_],Result4,Result5),
		remove([3,9,_,_],Result5,Result6),
		remove([5,25,_,_],Result6,Result7),
		remove([7,49,_,_],Result7,Result8),
		quicksort2(Result8,Result9),
